...
* [Git](https://github.com/ysomad/wiki/blob/main/git/README.md)
...
* [Алгоритмы и структуры данных](https://github.com/ysomad/wiki/tree/main/algorithms_and_data_structures)
